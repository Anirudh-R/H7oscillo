...
const uint8_t deviceDescriptor[SIZ_DEVICE_DESC] = {
    ...
    3,      /* index of string serial number */
...
const uint8_t stringManufac[SIZ_STRING_MANUFAC] = {
	SIZ_STRING_MANUFAC,  	/* Size of manufacturer string */
...
const uint8_t stringSerial[SIZ_STRING_SERIAL] = {
	SIZ_STRING_SERIAL,
    0x03,
    /* Serial number */
...
const uint8_t stringInterface[SIZ_STRING_INTERFACE] = {
    SIZ_STRING_INTERFACE,
    0x03,
    /* Interface 0: "ST Mass" */
