...
uint8_t vscale1 = 0;				/* Vertical scale of channel 1 */
uint8_t vscale2 = 0;				/* Vertical scale of channel 2 */
uint8_t tscale = 0;					/* Horizontal scale */
...
uint16_t toff = 0;					/* Horizontal offset */
...
const uint8_t trigsrcVals[] = {TRIGSRC_NONE, TRIGSRC_CH1, TRIGSRC_CH2};		/* source channel is denoted using color */
const uint8_t trigtypeVals[] = {TRIGTYPE_RIS, TRIGTYPE_FAL, TRIGTYPE_EDGE};
const char trigtypeDispVals[][4] = {"R", "F", "R/F"};
const uint8_t trigmodeVals[] = {TRIGMODE_AUTO, TRIGMODE_SNGL};
const char trigmodeDispVals[][5] = {"AUTO", "SNGL"};
